...
public class SQLDatabaseConnection {
    ...
    public String ExecuteCacheCommand(String CacheServerCommand, Object ObjectToCache, String CacheId, String CacheTags, String ExpiresIn) throws Exception
    {
    ...
    public Object ExecuteGetCacheCommand(Boolean ReturnRawBytes, String CacheId)
    {
        ...
        byte[] RequestBytes = CreateRequestBytes(GetCacheRequestHeader(ServerCommands.CacheGet.toString(), CacheId, "", ""), b);
        byte[] ResponseBytes = null;
        try
        {
            ResponseBytes = SendToServer(RequestBytes);
