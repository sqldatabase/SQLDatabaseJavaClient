...
public class Client {
	...
	public static void main(String[] args) throws IOException, Exception {
		...
		//MultipleActiveResultSets will return multiple responses reducing round trips and processing.
		//If multiple statements are executed without setting MultipleActiveResultSets only last result is returned.
		//ExtendedResultSets=true; will return more details such as tables, sql query etc.
		...
		// the above add function returns new cache id which is assigned to cId variable.
